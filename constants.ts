...
export const MOCK_DATA: AppData = {
  ...
  farmRequests: [
    {
      ...
      requesterId: 'user-farmer1',
      requestDate: '2025-10-25',
      status: 'Pending',
      reason: 'Expanding operations to new plot with excellent microclimate for specialty coffee',
    },
    {
      id: 'FR002',
      farmName: 'Sunrise Estate',
      location: 'Doi Chaang, Chiang Rai',
      altitude: '1400m',
      size: '3 hectares',
      latitude: 20.0847,
      longitude: 99.8825,
      ...
      status: 'Approved',
      reason: 'New high-altitude plot for Gesha variety cultivation',
      adminNotes: 'Excellent location, approved for premium variety production',
      reviewDate: '2025-10-22',
      reviewedBy: 'user-headjudge',
    },
    {
      id: 'FR003',
      ...
      status: 'Rejected',
      reason: 'Low altitude plot for experimental varieties',
      adminNotes: 'Altitude too low for specialty grade coffee production. Please submit request for plots above 1000m.',
  ...
  gapLogs: [
    { id: 'GAP001', farmPlotLocation: 'Finca La Esmeralda, Plot A', activityType: 'Fertilizer', date: '2025-06-15', productUsed: 'Organic Compost', quantity: '200 kg', notes: 'Applied around the base of the plants.' },
    { id: 'GAP002', farmPlotLocation: 'Finca La Esmeralda, Plot A', activityType: 'Pest Management', date: '2025-07-01', productUsed: 'Neem Oil Solution', quantity: '5 L', notes: 'Preventative spraying for coffee berry borer.' },
    { id: 'GAP003', farmPlotLocation: 'Hacienda Elida, Plot C4', activityType: 'Water Management', date: '2025-07-10', productUsed: 'Drip Irrigation', quantity: '2 hours', notes: 'Morning irrigation cycle.' },
    { id: 'GAP004', farmPlotLocation: 'Finca La Esmeralda, Plot A', activityType: 'Water Management', date: '2025-07-12', productUsed: 'Drip Irrigation', quantity: '1.5 hours', notes: 'Soil moisture was adequate.' },
  ],
  activityTypes: [
